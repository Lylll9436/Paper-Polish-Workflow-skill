...
- [x] **SECT-02**: Figure and table caption Skill generates or optimizes captions with geography-specific awareness (study area, CRS, legend description)
...
| SECT-02 | Phase 8: Figure/Table and Logic Skills | Complete |
